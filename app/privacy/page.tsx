...
export default function PrivacyPage() {
  return (
    <>
      <section className="bg-navy-900 text-white py-16 border-b border-navy-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h1 className="text-4xl font-bold mb-2">Privacy &amp; Terms</h1>
          <p className="text-silver-dark">Last updated: 2024</p>
        </div>
      </section>

      <section className="py-16 bg-navy-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 max-w-none">
          <div className="space-y-10 text-silver-light leading-relaxed">

            <div>
              <h2 className="text-2xl font-serif font-semibold text-white mb-4">Privacy Policy</h2>
              ...
              <h3 className="text-lg font-semibold text-white mt-6 mb-2">Information we collect</h3>
              ...
              <h3 className="text-lg font-semibold text-white mt-6 mb-2">How we use your information</h3>
              <ul className="list-disc ml-6 space-y-1 text-sm mb-4">
              ...
              <h3 className="text-lg font-semibold text-white mt-6 mb-2">Data storage and security</h3>
              ...
              <h3 className="text-lg font-semibold text-white mt-6 mb-2">Your rights</h3>
              ...
              <h3 className="text-lg font-semibold text-white mt-6 mb-2">AI use disclosure</h3>
              ...
              <h3 className="text-lg font-semibold text-white mt-6 mb-2">Contact for privacy matters</h3>
              <p className="text-sm">For privacy questions or data requests, contact us via the <a href="/contact" className="text-teal underline">contact page</a>.</p>
            </div>
            ...
            <div id="terms" className="scroll-mt-24">
              <h2 className="text-2xl font-serif font-semibold text-white mb-4">Terms of Service</h2>
              <p className="mb-4 text-sm">By using this website and engaging EasyAI&apos;s services, you agree to the following terms.</p>

              <h3 className="text-lg font-semibold text-white mt-6 mb-2">Services</h3>
              ...
              <h3 className="text-lg font-semibold text-white mt-6 mb-2">No guarantees</h3>
              ...
              <h3 className="text-lg font-semibold text-white mt-6 mb-2">Assessment and consultation content</h3>
              ...
              <h3 className="text-lg font-semibold text-white mt-6 mb-2">Changes to these terms</h3>
              ...
              <h3 className="text-lg font-semibold text-white mt-6 mb-2">Governing law</h3>
